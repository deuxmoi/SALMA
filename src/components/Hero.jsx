      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          >
            ...
            <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href="./CV_2026-09-15_SALMA_JOUA.pdf" download="CV_2026-09-15_SALMA_JOUA.pdf" target="_blank" rel="noopener noreferrer" className="btn-outline flex items-center w-full sm:w-auto justify-center">
